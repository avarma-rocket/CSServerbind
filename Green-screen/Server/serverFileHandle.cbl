...
*      Same as the Client Program the server uses a
*      parameter block described in mfclisrv.cpy

       linkage section.
       copy "mfclisrv.cpy".

*      input-rec is the same size in both client and server 
...
*      Initalisation of code for your server program. 
*      E.g. Opening your application dat files or creating dat files.
...
*      Processing code. e.g: read and writing of data files 
